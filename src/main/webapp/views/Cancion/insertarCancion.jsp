...
<body>  
  <nav id="menu">
    ...
    <center>
        <div class="container">
          <div class="title">Insertar Cancion</div>
          <div class="content">
            <form action="cancion" method="post">
              <div class="user-details">     
                <div class="input-box">
                    <span class="details">Nombre Cancion</span>
                    <input name="nombreCancion" id="nombre" type="text" placeholder="Nombre">
                  </div>     
                  <div class="input-box">
                    <span class="details">Fecha Grabacion</span>
                    <input name="fechaGrabacion" id="fecha" type="text" placeholder="2021-05-03">
                  </div>
                  <div class="input-box">
                    <span class="details">Duracion Cancion</span>
                    <input name="duracionCancion" id="duracion" type="text" placeholder="5">
                  </div>
                  <div class="input-box">
                    <span class="details">Estado Cancion</span>
                    <input type="checkbox" name="estadoCancion" id="estado" checked class="form-check-input">
