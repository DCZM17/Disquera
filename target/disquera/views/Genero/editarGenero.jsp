...
<body>
  <nav id="menu">
    ...
    <center>
      <div class="container">
        <div class="title">Editar Genero</div>
        <div class="content">
          ...
          <form action="genero" method="post">
            <div class="user-details">     
              <div class="input-box">
                  ...
                  <input  name="nombreGenero" id="nombre" type="text" value="${generoL.getNombreGenero()}">
                  <input hidden name="id" id="id" type="text" value="${generoL.getIdGenero()}" >
                </div>     
                <div class="input-box">
                  <span class="details">Estado Genero</span>
                  <input type="checkbox" name="estadoGenero" id="estado" checked class="form-check-input" value="${generoL.getEstadoGenero()}">
